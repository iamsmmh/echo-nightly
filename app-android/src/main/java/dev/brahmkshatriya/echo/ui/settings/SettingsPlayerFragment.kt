...
import dev.brahmkshatriya.echo.playback.PlaybackWatchdog
    ...
    class AudioPreference : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            PreferenceCategory(context).apply {
                ...
                SwitchPreferenceCompat(context).apply {
                    key = PlaybackWatchdog.WATCHDOG_KEY
                    title = getString(R.string.playback_watchdog)
                    summary = getString(R.string.playback_watchdog_summary)
                    layoutResource = R.layout.preference_switch
                    isIconSpaceReserved = false
                    setDefaultValue(true)
                    addPreference(this)
                ...
                SwitchPreferenceCompat(context).apply {
                    key = PlaybackRecoveryStore.AUTO_RESUME_KEY
                    title = getString(R.string.auto_resume)
                    summary = getString(R.string.auto_resume_summary)
                    layoutResource = R.layout.preference_switch
                    isIconSpaceReserved = false
                    setDefaultValue(true)
                    addPreference(this)
                ...
                SwitchPreferenceCompat(context).apply {
                    key = ChromecastBridge.ENABLE_CAST
                    title = getString(R.string.enable_cast)
                    summary = getString(R.string.enable_cast_summary)
                    layoutResource = R.layout.preference_switch
                    isIconSpaceReserved = false
                    setDefaultValue(true)
                    addPreference(this)

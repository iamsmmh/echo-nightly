...
import dev.brahmkshatriya.echo.common.helpers.EchoByteStream
...
data class Streamable(
    ...
    sealed class Source {
         ...
         *
         * @property streamProvider A function that provides an [EchoByteStream] from a given position.
         *
         * @see InputProvider
         */
        @Serializable
    ...
    /**
     * An interface that provides an [EchoByteStream] from a given position.
     *
    ...
    fun interface InputProvider {
        ...
        /**
         * Provides an [EchoByteStream] from a given position.
         *
         ...
         * @return An [EchoByteStream] from the given position and the total bytes that can be read, or -1 if unknown.
         */
        suspend fun provide(position: Long, length: Long): Pair<EchoByteStream, Long>
    }
